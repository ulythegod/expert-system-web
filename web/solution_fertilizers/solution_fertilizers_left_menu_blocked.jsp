            ...
            <div class="collapse" id="collapseProcessField">
                <div class = "tree">
                    <ul id="treeData" style="display: none;">
                        <li data-expanded="false"><a href="/solution_fertilizers_setting_mode_without_agriculture_system"><fmt:message key="LEFT_MENU_CREATE_SOLUTION_FERT"/></a></li>
                        <%--<li data-expanded="false"><a href="/solution_fertilizers_corrections_mode"><fmt:message key="LEFT_MENU_RESULTS_CORRECTION"/></a></li>--%>
                        <li data-expanded="false"><a href="/solution_fertilizers_results_mode?typeResult=2"><fmt:message key="LEFT_MENU_SHOW_RESULTS_FERT"/></a></li>
                    </ul>
                </div>
            </div>
        </li>
