                        ...
                        <div class="panel-setting-parameters-with-scroll">
                            ...
                            <div id="parameters1">
                                ...
                                <fieldset id="newSol" class="first">
                                    ...
                                    <input type="radio" class="first" name="agricultureSystRB" value="false" disabled="disabled" checked/> <fmt:message key="FERT_FORM_SETT_NEW_SOL"/>
                                ...
                                <fieldset id="chem_composition_data" disabled="disabled">
                                    ...
                                    <input type="text" name="humus" id="humus" disabled="disabled"/>
                                    <p class="disabled"><fmt:message key="FERT_FORM_AMOUNT_PO"/></p>
                                    <input type="text" name="phosphorus" id="phosphorus" disabled="disabled" />
                                    <p class="disabled"><fmt:message key="FERT_FORM_AMOUNT_KO"/></p>
                                ...
                                <fieldset id="coef1" disabled="disabled">
                                    ...
                                    <input type="radio" name="coeff1" value="true" id="coeff1" disabled="disabled" checked/> <fmt:message key="FERT_FORM_COEF_FIRM"/><br />
                                ...
                                <fieldset id="coef2" disabled="disabled">
                                    ...
                                    <input type="radio" name="coeff2" value="true" disabled="disabled" checked/> <fmt:message key="FERT_FORM_COEF_FIRM"/><br />
                                ...
                                <div class="form-buttons">
                                    ...
                                    <input type="button" value="<fmt:message key="PL_FORM_SETT_BUTT_CALC"/>" name="calc1" disabled="disabled"/>
...
<script type="text/javascript" src="/solution_fertilizers/js/script-solution-fertilizers-mode-blocked.js"> </script>
