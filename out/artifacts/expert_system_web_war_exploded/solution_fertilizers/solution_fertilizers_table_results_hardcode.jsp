<data class="data-hardcode">
    <table class="table table-bordered" id="table-top">
        <thead>
        </thead>
        <tbody>
        <tr>
    ...
    <div id="tabs">
        <ul class="nav nav-tabs" style="border: none;">
            <li class="active"><a data-toggle="tab" href="#CommonResHard"><fmt:message key="FERT_FORM_TABLE_COMMON_RES"/></a></li>
            <li class="presentation"><a data-toggle="tab" href="#ResDescriptionHard"><fmt:message key="FERT_FORM_TABLE_RES_DESCRIPTION"/></a></li>
        </ul>
    </div>
    <div class="tab-content">
        <div id="CommonResHard" class="tab-pane fade in active">
            <table class="table table-bordered" id="CommonResHard-table">
                <thead>
                <tr>
                ...
                <tbody>
                <tr>
                    <th class="fertilizers"><fmt:message key="FERT_FORM_SETT_REAL_POSSIBLE_PRODUCT"/></th>
                    <td class="fertilizers"></td>
                    <td class="fertilizers"></td>
                    <td class="fertilizers"></td>
                </tr>
                <tr>
                    <th class="fertilizers"><fmt:message key="FERT_FORM_SETT_CROP_NEED_ADD_MICROEL"/></th>
                    <td class="fertilizers"></td>
                    <td class="fertilizers"></td>
                    <td class="fertilizers"></td>
                </tr>
        ...
        <div id="ResDescriptionHard" class="tab-pane fade">
            <table class="table table-bordered" id="ResDescriptionHard-table">
                <thead>
                <tr>
